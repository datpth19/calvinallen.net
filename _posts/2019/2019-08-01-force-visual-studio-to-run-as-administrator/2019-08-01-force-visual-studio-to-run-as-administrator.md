---
title: "Force Visual Studio to Run As Administrator"
tags: [powershell,visualstudio]
description: "Sometimes you just want VS to run in Admin mode.  This post will show you how to do that with a simple PowerShell script."
---
